...
| `UseLInfNorm` | `use_linf_norm` | bool | `False` | Whether to use the infinity norm for the termination criteria or the L2 norm. |
| `UseAbsoluteTermination` | `use_absolute_termination` | bool | `False` | Whether to use the unscalled termination criteria or not. |
